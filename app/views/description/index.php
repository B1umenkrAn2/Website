...
<section class=" container py-5">
    ...
    <div class="container">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a href="#Info" class="nav-link active" data-toggle="tab">Info</a>
            </li>
            <li class="nav-item">
                <a href="#Sites" class="nav-link " data-toggle="tab">Sites</a>
            </li>
            <li class="nav-item">
                <a href="#Profiles" class="nav-link " data-toggle="tab">Profiles</a>
            </li>
            <li class="nav-item">
                <a href="#Horizons" class="nav-link " data-toggle="tab">Horizons</a>
            </li>
            <li class="nav-item">
                <a href="#Morphology" class="nav-link " data-toggle="tab">Morphology</a>
            </li>
            <li class="nav-item">
                <a href="#Physical" class="nav-link " data-toggle="tab">Physical</a>
            </li>
            <li class="nav-item">
                <a href="#Chemical" class="nav-link " data-toggle="tab">Chemical</a>
            </li>
        </ul>
        <div class="tab-content py-3">
            <div id="Info" class="tab-pane active">
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>TX_FACTOR1</td>
                            <td>First deviating factor distinguishing a soil sample from a modal pedon of its soil series (e.g. soil depth, colour)</td>
                        </tr>

                        <tr>
                            <td>TX_FACTOR2</td>
                            <td>Second deviating factor distinguishing a soil sample from a modal pedon of its soil series (e.g. soil depth, colour</td>
                        </tr>
                        ...
                        <tr>
                            <td>LOCALITY</td>
                            <td>A descriptive term to help identify the location of a sample below the level Province, County, Township, Road Junction</td>
                        </tr>
            ...
            <div id="Sites" class="tab-pane ">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>MICRO_TOP</td>
                        <td>Estimated height of mounds and distance between them</td>
                    </tr>
                    ...
                    <tr>
                        <td>ROCKINESS</td>
                        <td>Rockiness class respecting the percentage of the surface occupied by the exposed bedrock.</td>
                    </tr>
                    ...
                    <tr>
                        <td>PM1_MD_DEP</td>
                        <td>The mode of deposition of the uppermost parent material</td>
                    </tr>
            ...
            <div id="Horizons" class="tab-pane ">
                <table class="table table-hover">
                    <thead>
                    <tr >
                        <th>Attribute </th>
                    ...
                    <tr>
                        <td>L_DEPTH</td>
                        <td>Indicates the depth (cm) of the bottom of the horizon. For mineral soils the top of the mineral material is chosen as depth zero, and for any organic layers that are present (such as LFH) the values of both U_DEPTH and L_DEPTH will be negative.</td>
                    </tr>

                    <tr>
                        <td>U_DEPTH</td>
                        <td>Indicates the depth (cm) to the top of the horizon. For mineral soils the top of the mineral material is chosen as depth zero, and for any organic layers that are present (such as LFH) the values of both U_DEPTH and L_DEPTH will be negative.</td>
                    </tr>
                    ...
                    <tr>
                        <td>HZN_LIT</td>
                        <td>Sequential identifier for distinctive lithologies as associated with horizons or soil layers</td>
                    </tr>
            ...
            <div id="Morphology" class="tab-pane ">
                <table class="table table-hover">
                    <thead>
                    <tr >
                        <th>Attribute </th>
            ...
            <div id="Physical" class="tab-pane ">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>BULK_DEN</td>
                        <td>Identifies the bulk density. Values are for the fine earth fraction, excluding coarse fragment content (g/cm3)</td>
                    </tr>
            ...
            <div id="Chemical" class="tab-pane ">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>CARB_ORG</td>
                        <td>Indicates the percentage (%) of organic carbon by weight</td>
                    </tr>
